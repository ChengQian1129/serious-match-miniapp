...
const SCALES = {
  ...
  P5: { labels: ['通常做不到', '较难做到', '有时能做到', '通常能做到', '大多数时候都能做到'], special: [{ value: 'NA', label: '没有足够经验' }, { value: 'SKIP', label: '暂时跳过' }] }
}
...
const ITEMS = [
  item('RIN01', '即使暂时没有具体对象，我也愿意认真开始一段以长期相处为方向的关系。', 'A5', 'readiness_intent', { publicText: '即使现在没有具体对象，我也愿意认真认识一个可能长期在一起的人。' }),
  ...
  item('RIN04', '想到进入一段需要投入和承诺的关系，我总体上是愿意的。', 'A5', 'readiness_intent', { publicText: '想到一段关系需要长期花时间、承担责任，我现在总体还是愿意的。' }),
  item('RMV01', '我想开始一段关系，主要因为我确实希望和一个人建立共同生活。', 'A5', 'autonomous_motivation', { publicText: '我想谈恋爱，主要是因为我确实想和一个人长期相处、一起生活。' }),
  ...
  item('RCP02', '我目前有情绪余力关心另一个人的感受，而不只是勉强处理自己的事情。', 'A5', 'available_capacity', { publicText: '我现在还有精力关心另一个人的感受，不会只是勉强顾好自己。' }),
  ...
  item('RPN01', '比起随时在线，我更需要对方的回应节奏大体可预期。', 'N5', 'response_predictability', { role: 'profile', side: 'need', publicText: '比起随时秒回，我更在意对方大概什么时候会回、联系节奏比较稳定。' }),
  ...
  item('RPP02', '我的回应节奏大多稳定，不会无解释地忽冷忽热。', 'P5', 'response_predictability', { role: 'profile', side: 'provide', publicText: '我平时联系人的节奏比较稳定，不太会无缘无故忽冷忽热。' }),

  item('AIS01', '当我在意的人回复明显变慢时，我很难把注意力放回自己的生活。', 'E5', 'uncertainty_sensitivity'),
  item('AIS02', '关系尚未明确时，我常反复猜测对方是不是准备离开。', 'E5', 'uncertainty_sensitivity', { publicText: '两个人还没说清关系时，我常会猜对方是不是不想继续了。' }),
  ...
  item('AIS05', '关系出现距离感时，我需要尽快得到明确回应才能平静。', 'E5', 'uncertainty_sensitivity', { publicText: '感觉对方开始疏远时，我通常需要尽快听到一个明确说法，才能放下心。' }),
  ...
  item('AVD04', '我能够接受双方在重要事情上相互依赖。', 'E5', 'closeness_discomfort', { reverseScored: true, publicText: '重要的事情上，我能接受两个人互相依靠。' }),
  item('AVD05', '亲近的人想了解我的内心时，我有时会本能地拉开距离。', 'E5', 'closeness_discomfort'),
  item('AVD06', '持续而稳定的亲密通常不会让我觉得被束缚。', 'E5', 'closeness_discomfort', { reverseScored: true, publicText: '关系一直很亲近、很稳定，通常不会让我觉得被束缚。' }),
  item('ASN01', '再亲密的关系里，我也需要固定的独处时间。', 'N5', 'autonomy_space', { role: 'profile', side: 'need' }),
  item('ASN02', '即使关系稳定，我也需要双方各自保留一些不共同参与的兴趣和社交。', 'N5', 'autonomy_space', { role: 'profile', side: 'need', publicText: '即使关系很稳定，我也希望两个人各自保留一些兴趣、朋友和活动。' }),
  ...
  item('REG02', '当关系有压力时，我更可能减少回应、搁置话题或暂时消失。', 'E5', 'REG02', { role: 'observation', publicText: '关系里有压力时，我更可能少回复、先不谈，或者暂时躲开一会儿。' }),
  item('REG04', '我需要暂停时，通常会说明原因，以及大概什么时候再聊。', 'E5', 'REG04', { role: 'observation' }),

  item('CPN01', '争执升温时，我更希望先暂停一段时间，再继续讨论。', 'N5', 'conflict_pause', { role: 'profile', side: 'need', publicText: '吵得越来越激烈时，我更希望先停一会儿，冷静后再谈。' }),
  item('CPN02', '争执暂停后，我需要有不必当天解决问题的余地，只要双方约好何时继续。', 'N5', 'conflict_pause', { role: 'profile', side: 'need', publicText: '吵架暂停后，只要说好什么时候继续，我可以接受不在当天把问题解决。' }),
  item('CPP01', '情绪上来时，我能明确提出暂停，并说明大概何时回来继续。', 'P5', 'conflict_pause', { role: 'profile', side: 'provide', publicText: '情绪上来时，我通常能直接说想先停一下，并告诉对方大概什么时候再聊。' }),
  item('CPP02', '暂停期间，我通常不会故意失联来惩罚对方。', 'P5', 'conflict_pause', { role: 'profile', side: 'provide' }),
  item('RRN01', '分歧后，即使问题还没完全解决，我也需要双方确认这段关系仍值得继续。', 'N5', 'repair_reengagement', { role: 'profile', side: 'need', publicText: '吵完以后，就算问题还没完全解决，我也希望彼此先确认：我们还想继续这段关系。' }),
  item('RRN02', '冲突后，我希望对方能主动开启一次修复对话，而不是等事情自然过去。', 'N5', 'repair_reengagement', { role: 'profile', side: 'need', publicText: '吵完以后，我希望对方愿意主动回来把这件事再聊清楚，而不是当作没发生过。' }),
  item('RRP01', '冷静后，我通常会主动回到问题，并尝试理解对方的感受。', 'P5', 'repair_reengagement', { role: 'profile', side: 'provide' }),
  item('RRP02', '发现自己伤到对方时，我能具体承认造成的影响，而不只解释自己的动机。', 'P5', 'repair_reengagement', { role: 'profile', side: 'provide', publicText: '发现自己伤到对方时，我通常能直接承认自己哪里伤到了他，而不只是解释“我不是那个意思”。' })
]

const CHAPTERS = [
  { id: 'C1', title: '你现在想不想谈恋爱', theme: '关系意愿与自己的选择', instruction: '按你现在的状态回答。', itemIds: ITEMS.slice(0, 8).map(x => x.id) },
  { id: 'C2', title: '你现在有没有时间和精力', theme: '现实余力与回应的连续性', instruction: '按最近一个月的真实情况回答。', itemIds: ITEMS.slice(8, 16).map(x => x.id) },
  { id: 'C3', title: '对方态度变了，你通常会怎样', theme: '距离变化与常见反应', instruction: '没有类似经历的题，可以选“暂时说不好”。', itemIds: ITEMS.slice(16, 24).map(x => x.id) },
  { id: 'C4', title: '关系越来越亲近以后', theme: '亲近、依赖与个人空间', instruction: '按你实际会怎样回答，不按你觉得自己应该怎样。', itemIds: ITEMS.slice(24, 32).map(x => x.id) },
  { id: 'C5', title: '你希望对方怎么支持你', theme: '情绪支持与彼此空间', instruction: '按你真实需要和真实做法回答。', itemIds: ITEMS.slice(32, 40).map(x => x.id) },
  { id: 'C6', title: '吵架以后，你通常怎么处理', theme: '暂停、修复与重新靠近', instruction: '按过去比较常见的情况回答。', itemIds: ITEMS.slice(40, 48).map(x => x.id) }
]
...
function getItem(itemId) {
  ...
  return item ? Object.assign({}, item, { text: item.publicText || item.text }) : null
}
