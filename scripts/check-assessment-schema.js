...
assert.equal(fs.readFileSync(path.join(root, 'utils/assessment-v2/generated/report-engine.js'), 'utf8'), reportEngine.replaceAll("require('./schema')", "require('./questionnaire-definitions')").replace("require('../content/version')", "require('../../../shared/content/version')").replace("require('../content/claim-copy')", "require('../../../shared/content/claim-copy')").replace("require('../content/public-language.generated')", "require('../../../shared/content/public-language.generated')"))
