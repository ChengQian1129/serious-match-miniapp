...
assert.equal(CONTENT_VERSION, 'relationship-manual-copy-1.1.0')
assert.equal(REPORT_COPY_VERSION, 'relationship-manual-report-copy-1.1.0')
...
assert.equal(read('shared/content/followup-copy.js').includes('不参加，也不会影响你的报告'), true)
