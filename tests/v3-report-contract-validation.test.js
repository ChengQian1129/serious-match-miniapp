...
;['pages/v3-checkpoint/index', 'pages/v3-result/index', 'pages/v3-result-evidence/index'].forEach(route => assert.ok(app.pages.includes(route), `${route} is not registered`))
